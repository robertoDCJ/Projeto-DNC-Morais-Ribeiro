        ...
        <div className="md:flex md:justify-between items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mx-auto">
            <div className="text-center font-Alegreya">
              <h2 className="mb-4 text-2xl font-medium text-white dark:text-white">
              ...
              <ul className="text-white-500">
                <li>
                  <p className="text-base">
                    De Segunda a Sexta das 09:00 às 12:00 e
                  </p>
                ...
                <li className="flex flex-col justify-center items-center">
                  <div className="flex items-center m-2">
                    ...
                    <p className="text-base ml-2">
                      <strong>E-mail:</strong> moraiseribeiroadvju@gmail.com
                    </p>
                  </div>
                  <div className="flex items-center m-2">
                    <CallOutlinedIcon />
                    <p className="text-base ml-2">
                      <strong>Telefone:</strong> (12)99160-4267
                    </p>
                  </div>
                </li>
              </ul>
